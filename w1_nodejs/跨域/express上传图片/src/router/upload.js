...
const uploadPath =  path.join(__dirname,'../uploads/')//图片下载的路径
...
//2、多个文件上传
const multipleMiddleware = upload.array('photos', 5)
router.post('/photos/upload', multipleMiddleware, (req, res) => {
    // req.body
